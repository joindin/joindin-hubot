...
joindin-hubot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.  This one can be found as joindin-hubot in #joind.in on freenode
...
You can start joindin-hubot locally by running:
...
Then you can interact with joindin-hubot by typing `joindin-hubot help`.

    joindin-hubot> joindin-hubot help

    joindin-hubot> animate me <query> - The same thing as `image me`, except adds a few
